      ...
      $accounts = json_decode(file_get_contents('accounts.json'),1);
			if(isset($update->message)){
              ...
              $bot->sendphoto([ 'chat_id'=>$chatId,
                  'photo'=>"https://t.me/TEXT_PHP/6",
                   'caption'=>'🍁 𝒘𝒆𝒍𝒍𝒄𝒐𝒎𝒆 ๛ @QQQQQQ0 🍂',
                  'reply_markup'=>json_encode([
                      'inline_keyboard'=>[
                          [['text'=>'تسجيل حساب 🍂','callback_data'=>'login']],
                       [['text'=>"المطـور الاساسي 🍁", 'url'=>"https://t.me/QQQQQQ0"]],
                       [['text'=>"قناة البوت 🍂", 'url'=>"https://t.me/WWWWWWZ"]],
                      ]
                  ])
              ]);   
          } 
          	...
          	if($config['mode'] != null){
          		...
          		if($mode == 'addL'){
          			...
          			if(isset($body->message)){
          				if($body->message == 'challenge_required'){
          					...
          					$bot->sendMessage([
          							'chat_id'=>$chatId,
          							'parse_mode'=>'markdown',
          							'text'=>"كلمه السر او اليوزر خطأ 🛠️"
          					]);
          				}
		              ...
		              $bot->editMessageText([
		                  'chat_id'=>$chatId,
		                  'message_id'=>$mid,
		                  'text'=>"صفحه التحكم بالحسابات الوهمية",
          		  ...
          		  if(is_numeric($text)){
                      ...
                      'chat_id'=>$chatId,
                      'message_id'=>$mid,
                      'text'=>"اهلا بك فـي اداة صيد ⌯ @QQQQQQ0 ",
                  'reply_markup'=>json_encode([
                      'inline_keyboard'=>[
                          [['text'=>'تسجيل حساب 🍂','callback_data'=>'login']],
					...
					$bot->sendphoto([ 'chat_id'=>$chatId,
                  'photo'=>"https://t.me/TEXT_PHP/6",
                   'caption'=>'البوت ليس مجانا بل مدفوع عليك مراسلة المطور لشراء نسخة خاصة بك',
							'reply_markup'=>json_encode([
                  'inline_keyboard'=>[
                      [['text'=>'المطـور الاساسي🍂','url'=>'t.me/QQQQQQ0']]
                  ]
							])
					]);
				}
          ...
          if($data == 'login'){
            ...
            exec('screen -dmS gr php explore.php');
          	...
          	$bot->editMessageText([
                      'chat_id'=>$chatId,
                      'message_id'=>$mid,
                     'text'=>"اهلا بـك في اداة صيد ⌯ @QQQQQQ0",
                  'reply_markup'=>json_encode([
                      'inline_keyboard'=>[
                          [['text'=>'تسجيل حساب 🍂','callback_data'=>'login']],
                          [['text'=>'انواع السحب ✨','callback_data'=>'grabber']],
